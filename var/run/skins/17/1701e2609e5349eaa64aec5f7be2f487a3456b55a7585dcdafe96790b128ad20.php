...
/* D:\x-cart\skins\admin\center.twig */
class __TwigTemplate_23158ab3af8712fb90cca95428db0866571687847440bac34acdd5c164b9e716 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 6
        $this->loadTemplate("noscript.twig", "D:\\x-cart\\skins\\admin\\center.twig", 6)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("access_denied.twig", "D:\\x-cart\\skins\\admin\\center.twig", 19)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("license_message.twig", "D:\\x-cart\\skins\\admin\\center.twig", 23)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
";
    ...
    {
        return "D:\\x-cart\\skins\\admin\\center.twig";
    }
    ...
    {
        return new Twig_Source("", "D:\\x-cart\\skins\\admin\\center.twig", "");
    }
}
